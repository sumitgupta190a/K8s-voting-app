# TechyGuy Web Voting Application with Kubernetes sumit gupta wrong
...
```
git clone https://github.com/sumitgupta190a/K8s-voting-app.git
```

**Create techyguy Namespace**
```
kubectl create ns techyguy

kubectl config set-context --current --namespace techyguy
```
